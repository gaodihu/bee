...
[![Build Status](https://drone.io/github.com/gaodihu/bee/status.png)](https://drone.io/github.com/gaodihu/bee/latest)
...
```bash
go get -u github.com/gaodihu/bee
```
